...
#include <wb_controller/devices/ros.h>
...
public:
   ...
   Ps3JoyHandler(ros::NodeHandle& node, wb_controller::Controller* controller_ptr, const std::string& topic = "joy")
...
public:
    ...
    XboxJoyHandler(ros::NodeHandle& node, wb_controller::Controller* controller_ptr, const std::string& topic = "joy")
         :JoyHandler(node,controller_ptr,topic)
    {
    }
