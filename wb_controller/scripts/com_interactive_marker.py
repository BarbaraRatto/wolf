...
from wb_controller.msg import TasksPose
...
counter = 0
first_value = True
pub = rospy.Publisher('/hyqreal/wb_controller/tasks_desired', TasksPose, queue_size=10)
...
if __name__=="__main__":
    rospy.init_node("com_interactive_marker")

    server = InteractiveMarkerServer("com_interactive_marker")
