...
public:
    ...
    void cmdCallback(const geometry_msgs::Twist& msg)
    {
        ...
        else
        {
            ...
            base_velocity_x_scale_ = base_velocity_y_scale_ = base_velocity_z_scale_ = 0.0;
            base_velocity_roll_scale_ = base_velocity_pitch_scale_ = base_velocity_yaw_scale_ = 0.0;
        }
