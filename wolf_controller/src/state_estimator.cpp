...
StateEstimator::StateEstimator(StateMachine::Ptr state_machine, QuadrupedRobot::Ptr robot_model)
{
  ...
  //kf_estimation_ = std::make_shared<KalmanFilterEstimatorPinocchio>(wolf_controller::_robot_name,wolf_controller::_period);
  kf_estimation_ = std::make_shared<KalmanFilterEstimatorRbdl>(wolf_controller::_robot_name,wolf_controller::_period);
